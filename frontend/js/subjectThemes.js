...
const SUBJECT_THEME = {
    ...
    "Chemistry": { icon: "", img: "../Assets/subjects/chemistry.jpg", credit: "Belikov Maxim / Wikimedia Commons (CC BY 4.0)" },
    ...
    "Ethics": { icon: "", img: "../Assets/subjects/ethics.jpg", credit: "Domenico Fetti / Wikimedia Commons (Public domain)" },
    ...
    "History": { icon: "", img: "../Assets/subjects/history.jpg", credit: "Gary Todd / Wikimedia Commons (CC0)" },
    "History & Citizenship": { icon: "", img: "../Assets/subjects/history-citizenship.jpg", credit: "JJ Harrison / Wikimedia Commons (CC BY-SA 3.0)" },
    ...
    "ICT in Accounting": { icon: "", img: "../Assets/subjects/ict-in-accounting.jpg", credit: "Wikimedia Commons (CC0)" },
    ...
    "Kinyarwanda": { icon: "", img: "../Assets/subjects/kinyarwanda.jpg", credit: "Ericnkurunziza / Wikimedia Commons (CC BY-SA 4.0)" },
    "Kiswahili": { icon: "", img: "../Assets/subjects/kiswahili.jpg", credit: "NASA Earth Observatory / Wikimedia Commons (Public domain)" },
    ...
    "Physics": { icon: "", img: "../Assets/subjects/physics.jpg", credit: "Stanislav Liubauskas / Wikimedia Commons (CC BY 4.0)" },
    "Religion & Ethics": { icon: "", img: "../Assets/subjects/religion-ethics.jpg", credit: "Dragfyre / Wikimedia Commons (CC BY-SA 3.0)" },
    "Religious Studies": { icon: "", img: "../Assets/subjects/religion-ethics.jpg", credit: "Dragfyre / Wikimedia Commons (CC BY-SA 3.0)" },
    ...
    "Social Studies": { icon: "", img: "../Assets/subjects/social-studies.jpg", credit: "Bembety / Wikimedia Commons (CC BY-SA 4.0)" },
    "Social and Religious Studies": { icon: "", img: "../Assets/subjects/religion-ethics.jpg", credit: "Dragfyre / Wikimedia Commons (CC BY-SA 3.0)" },
