...
const I18N_DICT = {
  en: {
    ...
    "auth.createAccount": "Create Account", "auth.joinPlatform": "Join the Homework platform",
    ...
    "cd.textTab": "📝 Text", "cd.linkDriveTab": "🔗 Link / Drive", "cd.uploadPdfTab": "📄 Upload PDF",
    "cd.yourAnswer": "Your Answer", "cd.writeAnswerPlaceholder": "Write your answer here…",
    "cd.websiteLink": "Website / Google Drive Link", "cd.submitAssignment": "Submit Assignment",
    ...
    "admin.platformInfoText": "Homework Platform – National Digital Education System for Secondary Education in Rwanda",
  ...
  fr: {
    ...
    "auth.createAccount": "Créer un compte", "auth.joinPlatform": "Rejoignez la plateforme Homework",
    ...
    "cd.textTab": "📝 Texte", "cd.linkDriveTab": "🔗 Lien / Drive", "cd.uploadPdfTab": "📄 Envoyer un PDF",
    "cd.yourAnswer": "Votre réponse", "cd.writeAnswerPlaceholder": "Écrivez votre réponse ici…",
    "cd.websiteLink": "Lien du site / Google Drive", "cd.submitAssignment": "Soumettre le devoir",
    ...
    "admin.platformInfoText": "Plateforme Homework – Système éducatif numérique national pour l'enseignement secondaire au Rwanda",
  ...
  rw: {
    ...
    "auth.createAccount": "Fungura Konti", "auth.joinPlatform": "Injira muri Homework",
    ...
    "cd.textTab": "📝 Inyandiko", "cd.linkDriveTab": "🔗 Ihuza / Drive", "cd.uploadPdfTab": "📄 Ohereza PDF",
    "cd.yourAnswer": "Igisubizo Cyawe", "cd.writeAnswerPlaceholder": "Andika igisubizo cyawe hano…",
    "cd.websiteLink": "Ihuza rya Site / Google Drive", "cd.submitAssignment": "Ohereza Umwitozo",
    ...
    "admin.platformInfoText": "Homework Platform – Sisitemu Nyarwanda y'Uburezi bw'Icyiciro cya Kabiri",
